...
echo ""
echo "To update the skyline-grok plugin, run the skyline-grok:update-plugin skill, or:"
echo "  grok plugin marketplace update skylence-plugins && grok plugin update skyline-grok"
echo ""
